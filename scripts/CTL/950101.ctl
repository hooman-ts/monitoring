OPTIONS ( DIRECT=TRUE)
LOAD DATA
INFILE 'J:\Repository\1395\Debit\950101\shap\581672000.acq'
INFILE 'J:\Repository\1395\Debit\950101\shap\581672000.inq'
INTO TABLE "SHAPARAK"."DEBITTRAN_LOAD"
APPEND
  FIELDS TERMINATED BY '|' OPTIONALLY ENCLOSED BY '"' 
    TRAILING NULLCOLS 
(
"FILEDATE" EXPRESSION "TO_DATE(:TRNSRCVDATE,'YYYY/MM/DD','NLS_CALENDAR=PERSIAN')",
